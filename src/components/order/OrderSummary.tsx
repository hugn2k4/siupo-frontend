  ...
  return (
    <div className="bg-white rounded-lg p-4 shadow-md flex flex-col gap-3 text-slate-900">
      <div className="flex items-center gap-2">
        ...
        <div className="font-semibold text-base">Tóm tắt đơn</div>
      </div>

      <div className="flex flex-col gap-2">
        {items.length === 0 && combos.length === 0 && <div className="text-gray-500">Giỏ hàng trống</div>}
      ...
      <div className="border-t border-dashed border-gray-200 pt-3">
        <div className="bg-amber-50 p-3 rounded-md">
          <div className="flex justify-between mb-2">
            <div className="text-sm text-gray-500">Món lẻ</div>
            <div className="font-semibold">{itemsTotal.toLocaleString()} đ</div>
          </div>
          <div className="flex justify-between mb-3">
            <div className="text-sm text-gray-500">Combo</div>
            <div className="font-semibold">{combosTotal.toLocaleString()} đ</div>
          </div>
          <div className="flex justify-between items-center">
            <div className="font-extrabold text-lg">Tổng</div>
            <div className="font-extrabold text-lg">{total.toLocaleString()} đ</div>
          </div>
          <button
            onClick={onCheckout}
            disabled={disabled}
